...
//
//  override def setUp() {
//    val traceFile = scala.io.Source.fromFile("/home/samira/workspace/workspace-scala/setak/src/test/scala/akka/setak/examples/sleepingbarber/sleepingbarber.txt")
